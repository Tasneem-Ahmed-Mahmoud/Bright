 ...
 <li class="menu-item  ">
  <a href="javascript:void(0);" class="menu-link menu-toggle">
    ...
    <div data-i18n="Dashboards">Main Services</div>
  </a>
  <ul class="menu-sub">
    <li class="menu-item ">
      <a href="{{ route('main-services.index') }}" class="menu-link">
        <div data-i18n="Analytics"> Main Service</div>
      </a>
    </li>
    
    <li class="menu-item ">
      <a href="{{ route('main-services.create') }}" class="menu-link">
        <div data-i18n="Analytics">Add Main Service</div>
      </a>
    </li>
